                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="" method="POST">
                                    ...
                                    <input type="hidden" name="court_url" value="https://services.ecourts.gov.in/ecourtindia_v4_bilingual/cases/s_casetype.php?state=D&state_cd=26&dist_cd=1">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="court_complex_code" id="court_complex_code" class="form-control">
                                        ...
                                        <option value="1@1,2,3,4@N">Karkardooma Court Complex</option>
                                    </select>
                                </div>
