        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">South West Delhi:</h4>
...
<form action="{{route('court.store')}}" method="POST">
    {{ csrf_field() }}
    <input type="hidden" name="court_url" value="https://services.ecourts.gov.in/ecourtindia_v4_bilingual/cases/s_orderdate.php?state=D&state_cd=26&dist_cd=6">
...
<div class="form-group">
    ...
    <select name="court_complex_code" id="court_complex_code" class="form-control">
        ...
        <option value="1@1,2,3,5@N">Dwarka Court Complex</option>
    </select>
</div>
<div class="form-group" style="display: none;">
    ...
    <select name="court_code" id="court_code" class="form-control">
        ...
        <option value="1">District and Session Judge, South-West DWK</option>
        <option value="2">Chief Metropolitan Magistrate, South-West DWK</option>
        <option value="3">Senior Civil Judge cum RC, South-West DWK</option>
        <option value="5">Principal Judge Family Court, South West, DWK</option>
    </select>
</div>
