        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">West Delhi:</h4>
...
<div class="form-group" style="display: none;">
    ...
    <select name="court_code" id="court_code" class="form-control">
        ...
        <option value="1">District and Sessions Judge, West, THC</option>
        <option value="2">Chief Metropolitan Magistrate, West, THC</option>
        <option value="3">Senior Civil Judge cum RC, West, THC</option>
        <option value="4">Principal Judge Family Court, West, THC</option>
    </select>
</div>
