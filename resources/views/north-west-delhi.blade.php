        ...
        <div class="page-title-box">
            <div class="container-fluid">
                <div class="row align-items-center">
                    <div class="col-md-8">
                        <h4 class="page-title mb-1">North West Delhi:</h4>
...
<form action="{{route('court.store')}}" method="POST">
    {{ csrf_field() }}
    <input type="hidden" name="court_url" value="https://services.ecourts.gov.in/ecourtindia_v4_bilingual/cases/s_orderdate.php?state=D&state_cd=26&dist_cd=5">
...
<div class="form-group" style="display: none;">
    ...
    <select name="court_code" id="court_code"  class="form-control">
        ...
        <option value="1">District and Sessions Judge, North-West, RHC</option>
        <option value="2">Chief Metropolitan Magistrate, North-West, RHC</option>
        <option value="3">Senior Civil Judge cum RC, North-West, RHC</option>
        <option value="4">Principal Judge Family Court, North West, RHC</option>
    </select>
</div>
